...
methods and a mux-router style interface to the github.com/skybet/slack package.
...
But wait, there's more! Well, until there's more, the slackbot package exposes github.com/skybet/slack RTM and Client objects enabling a consumer to interact with the lower level package directly:
